...
class ProductsController extends VoyagerBreadController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $groupsForProduct = $product->groups()->get();

        // return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable'));
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'allGroups', 'groupsForProduct'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$request->ajax()) {
            ...
            //re-insert if there's only one group checked
            if($request->group){
    ...
    public function create(Request $request)
    {
        ...
        // return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable'));
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'allGroups'));
    }
